...
TEST(TextBufferTest, NewBufferTest) {
  qsl::TextBuffer textBuffer(1024);
...
TEST(TextBufferTest, ReserveTest) {
  qsl::TextBuffer textBuffer(32);
...
TEST(TextBufferTest, PushTest) {
  qsl::TextBuffer textBuffer(16);
...
TEST(TextBufferTest, PushLongTest) {
  qsl::TextBuffer textBuffer(8);
...
TEST(TextBufferTest, SwapTransferTest) {
  qsl::TextBuffer textBufferA(8);
  qsl::TextBuffer textBufferB(16);
  textBufferA << "I am A";
...
TEST(TextBufferTest, ClearTest) {
  qsl::TextBuffer textBuffer(4);
  textBuffer << "test";
